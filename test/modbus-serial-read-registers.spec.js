            ...
            modbusSerialPort.connect().then(function(){
                ...
                setTimeout(function(){
                    if (modbusSerialPort.serialPort != null) {
                        ...
                        modbusSerialPort.serialPort.writeToComputer(Buffer.from(  [0x01, 0x03, 0x14, 0x02, 0x02, 0x02, 0x02, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x00, 0x08, 0x00, 0x09, 0x9c, 0x43]));
                  }
                }, 1000);
